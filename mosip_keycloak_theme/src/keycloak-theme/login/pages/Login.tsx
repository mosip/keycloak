...
export default function Login(props: PageProps<Extract<KcContext, { pageId: "login.ftl" }>, I18n>) {
    ...
    return (
        ...
        >
            <div id="kc-form" className={clsx(realm.password && social.providers !== undefined && getClassName("kcContentWrapperClass"), 'pt-10')}>
                <div
                    id="kc-form-wrapper"
                    className={clsx(
                        realm.password &&
                ...
                >
                    {realm.password && (
                        <form id="kc-form-login" onSubmit={onSubmit} action={url.loginAction} method="post">
                            ...
                            <div className={getClassName("kcFormGroupClass")}>
                                <label htmlFor="password" className={(getClassName("kcLabelClass"), 'text-hTextColor text-xl')}>
                                    {msg("password")}
                                </label>
                                <input
                                    tabIndex={2}
